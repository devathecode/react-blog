...
const Footer = () => {
    return (
        <footer className="text-center lg:text-left bg-sky-900 text-white">
            <div className="flex justify-center items-center lg:justify-between p-6 border-b border-white">
          ...
          ">
            ...
            <div className="text-center p-6 bg-sky-900 border-t border-white">
                <span>© 2021 Copyright:</span>
                <a className="text-white font-semibold" href="https://tailwind-elements.com/">Tailwind Elements</a>
            </div>
        </footer>
    );
};
